...
Blockly.inject = function(container, opt_options) {
  ...
  var workspace = Blockly.createMainWorkspace_(svg, options, blockDragSurface, wsDragSurface);
 ...
 * @param {?Blockly.WsDragSurfaceSvg} wsDragSurface  The surface to hold the
